...
入力:
  眼腫瘍解析/眼腫瘍手術トレンド_2014_2024.csv （都道府県別集計由来の真の全国合計、年次）
  眼腫瘍解析/人口_4群層別化_2014_2024.csv （4群人口、年次）
出力:
...
def main():
    df_total = pd.read_csv(os.path.join(BASE_DIR, "眼腫瘍手術トレンド_2014_2024.csv"))
    df_pop = pd.read_csv(os.path.join(BASE_DIR, "人口_4群層別化_2014_2024.csv"))
