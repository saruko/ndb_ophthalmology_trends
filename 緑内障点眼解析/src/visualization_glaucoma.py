...
# 薬効群（作用機序に基づく分類）。preprocess_glaucoma.GROUP_DEFS と対応する
CLASS_CODES = ["PGA", "BETA", "CAI", "ALPHA2", "ROCK", "PARASYMPATHO",
               "ALPHA1", "ION_CHANNEL", "FDC_TOTAL", "OTHER_NON_GL",
               "GLAUCOMA_EYE_TOTAL"]
SUBGROUP_CODES = ["PGA_FP", "PGA_EP2", "BETA_NONSEL", "BETA_B1SEL", "BETA_A1B"]
